(function() {
  ...
  [{
   ...
   },
   {
    ...
    var objectResult = heroesContainer.getData();
    var objectString = JSON.stringify(objectResult);
    console.dir(objectString);
    console.dir(JSON.stringify(expectedResult));
    console.dir(objectString == JSON.stringify(expectedResult));
  });
